...
class NatsClient(EventBroker):
    def __init__(self, config: NatsSettings, channels: List[str], logger: Logger):
        ...
        # There is no need to initialize topics in NATS
        self.channels: List[str] = channels
        self.logger: Logger = logger
        self.subscribers: Dict[str, nats_sync.nats_ctx.NATSSub] = dict()
    ...
    def publish(self, channel: str, data):
        ...
        self.logger.info(f"Publishing message to NATS topic {channel}: {serialized_data}")
